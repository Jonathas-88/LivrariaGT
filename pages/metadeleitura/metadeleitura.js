        ...
        booksContainer.innerHTML = livrosFiltrados.map(item => {
            ...
            <div class="div-card">
                ...
                <div class="div-texto">
                    ...
                    <button onclick="adicionarLivro('${urlImagem}')" class="rounded-md justify-center flex w-full h-6 p-1 border border-blue-500"><i class="text-blue-500 fa-solid fa-plus"></i></button>
                </div>
            </div>
            `
        }).join('')
